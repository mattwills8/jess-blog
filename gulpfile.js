...
gulp.task('zip', ['clean:zip'], () => {
  return gulp
    .src(zipOpts.productionZipFiles)
...
gulp.task('deploy', () => {
  ...
  return gulp
    .src(FTP.src, { base: FTP.base, buffer: false })
